...
import { Mail, Lock, UserPlus, AlertCircle, Loader2, CheckCircle2 } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(typeof errorData === 'string' ? errorData : errorData?.message || 'Registration failed. Try again.');
    } finally {
      setLoading(false);
    }
  };
